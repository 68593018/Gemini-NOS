...
static const nos_service_def_t g_proca_services[] = {
...
static const nos_service_def_t g_procb_services[] = {
    { .service_id = 204, .node_name = "ProcB", .provider_comp_id = 4 },
    { .service_id = 0 }
};
static const nos_node_def_t g_nodes[] = {
    {
        ...
        .services = g_proca_services, .service_count = 4
    },
    {
        ...
        .services = g_procb_services, .service_count = 1
    },
};
