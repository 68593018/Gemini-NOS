...
static const nos_platform_init_func_t g_infra_inits[] = { nos_kv_db_init ,nos_log_init , NULL };
const nos_node_def_t g_local_node_def = {
    ...
    .services = g_local_services, .service_count = 6, .platform_inits = g_infra_inits
};
