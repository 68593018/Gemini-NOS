...
static const nos_platform_init_func_t g_infra_inits[] = { nos_log_init ,nos_kv_db_init ,nos_timer_init , NULL };
const nos_node_def_t g_local_node_def = {
    ...
    .services = g_local_services, .service_count = 8, .platform_inits = g_infra_inits
};
